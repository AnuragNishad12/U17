...
import 'package:you_app/Science/Physics/Showing_physics.dart';
import 'package:you_app/Science/Physics/aEarth.dart';
import 'package:you_app/Science/Physics/alison.dart';

class Options_Physics extends StatelessWidget {
  const Options_Physics({super.key});
              ...
              children: [
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Showing_Physics()),
                    );
                  },
                  child: Container(
                    width: 400,
